...
export default function CancelCanvaProPage() {
          const meta = pickMetaVariant("cancel-canva-pro", {
            ...
            canonical: "https://subveris.com/cancel-canva-pro",
    ...
    <main className="min-h-screen bg-[radial-gradient(circle_at_top_left,_rgba(16,185,129,0.14),_transparent_35%),linear-gradient(135deg,_#f8fffc_0%,_#f3f7f9_100%)] text-slate-900 dark:bg-[radial-gradient(circle_at_top_left,_rgba(16,185,129,0.16),_transparent_35%),linear-gradient(135deg,_#07140f_0%,_#0f172a_100%)] dark:text-slate-100">
      <div className="mx-auto flex max-w-6xl flex-col gap-8 px-4 py-10 sm:px-6 lg:px-8">
        <header className="rounded-[28px] border border-emerald-500/20 bg-white/80 p-8 shadow-[0_25px_80px_-30px_rgba(15,23,42,0.35)] backdrop-blur-xl dark:border-emerald-400/20 dark:bg-slate-900/70">
          <div className="inline-flex items-center rounded-full border border-emerald-500/20 bg-emerald-500/10 px-3 py-1 text-sm font-medium text-emerald-700 dark:text-emerald-300">{getProductBadge("Canva Pro")}</div>
          ...
          <div className="mt-6 flex flex-wrap gap-3">
            <button
              type="button"
              onClick={() => {
                  try { reportAbConversion('cancel-canva-pro', 'start-with-subveris'); } catch (e) {}
        ...
        <div className="space-y-6">
          <section className="rounded-[24px] border border-red-500/30 bg-red-50/80 p-7 shadow-[0_15px_50px_-25px_rgba(15,23,42,0.28)] backdrop-blur dark:border-red-500/20 dark:bg-red-950/20">
            <div className="flex gap-4">
              ...
              <div>
                <h2 className="text-xl font-semibold text-red-900 dark:text-red-200">The Team Owner Trap</h2>
                <p className="mt-2 text-base leading-8 text-red-800 dark:text-red-300">
                  If you use Canva Pro within a "Team" setup (even if it's just a small group for a project), only the designated Team Owner can cancel or downgrade the subscription. Regular team members don't have the permissions to do it themselves. Also, make sure to explicitly downgrade to the free plan instead of completely deleting your account; dropping to the free tier safely preserves all your custom designs, it just locks away the premium brand kits and fonts.
                </p>
              </div>
            </div>
          </section>
          ...
          <section className="rounded-[24px] border border-slate-200/80 bg-white/75 p-7 shadow-[0_15px_50px_-25px_rgba(15,23,42,0.28)] backdrop-blur dark:border-slate-800 dark:bg-slate-900/70">
            ...
            <ol className="mt-5 space-y-3 pl-5 text-slate-600 dark:text-slate-300">
              <li className="list-decimal leading-7">Log into your account at <strong>Canva.com</strong>.</li>
              <li className="list-decimal leading-7">Click the <strong>Gear icon</strong> (Account settings) in the top right corner.</li>
              <li className="list-decimal leading-7">Select <strong>Billing & plans</strong> from the left-hand sidebar menu.</li>
              <li className="list-decimal leading-7">Under your plan details, click on the <strong>three dots (...)</strong> and select <strong>Cancel subscription</strong>.</li>
              <li className="list-decimal leading-7">Follow the exit steps to confirm your downgrade.</li>
            </ol>
          </section>
        </div>
        ...
        <CancelPageJsonLd productName="Canva Pro" url="https://subveris.com/cancel-canva-pro" steps={steps} />
        ...
        <section className="rounded-[32px] border border-emerald-500/20 bg-gradient-to-br from-emerald-600 via-emerald-500 to-cyan-600 p-8 text-white shadow-[0_25px_90px_-35px_rgba(5,150,105,0.6)]">
          ...
          <button
            type="button"
            onClick={() => {
              try { reportAbConversion('cancel-canva-pro', 'create-account-hero'); } catch (e) {}
              setAuthDefaultTab('signup');
              setAuthModalOpen(true);
            }}
