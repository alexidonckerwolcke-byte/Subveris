    ...
    <main className="min-h-screen bg-[radial-gradient(circle_at_top_left,_rgba(16,185,129,0.14),_transparent_35%),linear-gradient(135deg,_#f8fffc_0%,_#f3f7f9_100%)] text-slate-900 dark:bg-[radial-gradient(circle_at_top_left,_rgba(16,185,129,0.16),_transparent_35%),linear-gradient(135deg,_#07140f_0%,_#0f172a_100%)] dark:text-slate-100">
      <div className="mx-auto flex max-w-6xl flex-col gap-8 px-4 py-10 sm:px-6 lg:px-8">
        <header className="rounded-[28px] border border-emerald-500/20 bg-white/80 p-8 shadow-[0_25px_80px_-30px_rgba(15,23,42,0.35)] backdrop-blur-xl dark:border-emerald-400/20 dark:bg-slate-900/70">
          <div className="inline-flex items-center rounded-full border border-emerald-500/20 bg-emerald-500/10 px-3 py-1 text-sm font-medium text-emerald-700 dark:text-emerald-300">{getProductBadge("Microsoft 365")}</div>
          ...
          <div className="mt-6 flex flex-wrap gap-3">
            <button
              type="button"
              onClick={() => {
                  try { reportAbConversion('cancel-microsoft-365', 'start-with-subveris'); } catch (e) {}
        ...
        <div className="space-y-6">
          <section className="rounded-[24px] border border-red-500/30 bg-red-50/80 p-7 shadow-[0_15px_50px_-25px_rgba(15,23,42,0.28)] backdrop-blur dark:border-red-500/20 dark:bg-red-950/20">
            <div className="flex gap-4">
              ...
              <div>
                <h2 className="text-xl font-semibold text-red-900 dark:text-red-200">The "Recurring Billing" Phrase</h2>
                <p className="mt-2 text-base leading-8 text-red-800 dark:text-red-300">
                  Microsoft deliberately hides the hard "Cancel" button behind the confusing phrasing "Turn off recurring billing". This throws a lot of people off, making them think they are completely deleting their account or files. Don't worry: turning this off is exactly what you want. It means you keep full access to your software and files until your current paid period officially ends, after which it expires quietly without an automatic credit card charge.
                </p>
              </div>
            </div>
          </section>
          ...
          <section className="rounded-[24px] border border-slate-200/80 bg-white/75 p-7 shadow-[0_15px_50px_-25px_rgba(15,23,42,0.28)] backdrop-blur dark:border-slate-800 dark:bg-slate-900/70">
            ...
            <ol className="mt-5 space-y-3 pl-5 text-slate-600 dark:text-slate-300">
              <li className="list-decimal leading-7">Go to <strong>account.microsoft.com</strong> and sign in with your Microsoft account.</li>
              <li className="list-decimal leading-7">In the top navigation bar, click on <strong>Services & subscriptions</strong>.</li>
              <li className="list-decimal leading-7">Locate <strong>Microsoft 365</strong> and click <strong>Manage</strong> next to it.</li>
              <li className="list-decimal leading-7">Click on <strong>Cancel subscription</strong> or select <strong>Turn off recurring billing</strong>.</li>
              <li className="list-decimal leading-7">Follow the prompts on the screen to confirm your choice.</li>
            </ol>
          </section>
        </div>
        ...
        <CancelPageJsonLd productName="Microsoft 365" url="https://subveris.com/cancel-microsoft-365" />
        ...
        <section className="rounded-[32px] border border-emerald-500/20 bg-gradient-to-br from-emerald-600 via-emerald-500 to-cyan-600 p-8 text-white shadow-[0_25px_90px_-35px_rgba(5,150,105,0.6)]">
          ...
          <button
            type="button"
            onClick={() => {
              try { reportAbConversion('cancel-microsoft-365', 'create-account-hero'); } catch (e) {}
              setAuthDefaultTab('signup');
              setAuthModalOpen(true);
            }}
