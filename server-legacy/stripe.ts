...
import { getRequiredEnv, getStripePriceId } from './config.js';
...
export const stripe = createStripeClient(getRequiredEnv('STRIPE_SECRET_KEY'));
...
const premiumPriceId = getStripePriceId(
  ['STRIPE_PREMIUM_PRICE_ID', 'VITE_STRIPE_PREMIUM_PRICE_ID'],
  'price_1TM9r1JSf7SJ8WWRiocez8wo',
  'STRIPE_PREMIUM_PRICE_ID'
);
const familyPriceId = getStripePriceId(
  ['STRIPE_FAMILY_PRICE_ID', 'VITE_STRIPE_FAMILY_PRICE_ID'],
