 ...
 */
function checkNotificationPreference(userId, preferenceType) {
    return __awaiter(this, void 0, void 0, function () {
        var supabase, _a, data, error, column, error_1;
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 1:
                    ...
                    column = getPreferenceColumn(preferenceType);
                    return [2 /*return*/, data[column] === true];
                case 2:
                    error_1 = _b.sent();
                    console.error('[NotificationPreference] Error checking preference:', error_1);
 ...
 */
function getPreferenceColumn(preferenceType) {
