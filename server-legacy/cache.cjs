...
var CacheService = /** @class */ (function () {
    ...
    CacheService.prototype.getOrSet = function (key_1, fetcher_1) {
        return __awaiter(this, arguments, void 0, function (key, fetcher, ttlSeconds) {
            var value;
            if (ttlSeconds === void 0) { ttlSeconds = 3600; }
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        value = _a.sent();
                        return [4 /*yield*/, this.set(key, value, ttlSeconds)];
                    case 3:
                        _a.sent();
                        return [2 /*return*/, value];
                }
